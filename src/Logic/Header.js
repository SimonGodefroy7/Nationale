...
class Header extends Component {
  render() {
    return (
      <StyledHeader>
        <StyledFlexBox flexDirection="row" justifyContent="space-between" alignItems="center">
          <StyledAnchor as={Link} paddingless hoverless to="/">
            <StyledMediaQuery largeScreenFirst breakpoint={style.mediaSize.tablet}>
              <StyledH1><Translator id="Header.headerTitle" /></StyledH1>
            </StyledMediaQuery>
            <StyledMediaQuery breakpoint={style.mediaSize.tablet}>
              <StyledH1><Translator id="Header.headerTitleShort" /></StyledH1>
            </StyledMediaQuery>
          </StyledAnchor>
          <StyledFlexBox>
            <LangMenu />
